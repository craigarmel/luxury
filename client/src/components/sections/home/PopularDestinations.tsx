...
const destinations = [
  { name: 'Santorini', propertyCount: 42, image: '/villa.jpg' },
  { name: 'Bali', propertyCount: 68, image: '/villa.jpg' },
  { name: 'Amalfi Coast', propertyCount: 35, image: '/villa.jpg' },
  { name: 'Maldives', propertyCount: 29, image: '/villa.jpg' },
]
